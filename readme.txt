...
The map uses MapLibre GL JS with an in-app Makkah basemap, so the full city view appears without relying on external map-tile downloads; it is constrained to Makkah city bounds, with neighbourhood priority areas coloured green, orange, or red.
